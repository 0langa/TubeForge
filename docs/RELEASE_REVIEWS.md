...
Status: pass for the confirmed public, local single-user deployment model.
...
- Threat model signed off for public single-user desktop distribution.
- MIT license recorded before outside contributions are accepted.
