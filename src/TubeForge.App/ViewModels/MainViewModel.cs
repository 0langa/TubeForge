...
public sealed class MainViewModel : INotifyPropertyChanged, IDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (sourceIdentity.Caption is { } caption &&
    ...
    private CaptionEmbedSelection? SelectedCaptionEmbedSelection()
    {
        if (!EmbedSelectedCaption || SelectedCaptionTrack is null)
        {
            return null;
        }

        var selection = new CaptionEmbedSelection(
            SelectedCaptionTrack.Track.LanguageCode,
            SelectedCaptionTrack.Track.IsAutoGenerated);
